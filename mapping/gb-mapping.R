...
map <- get_stamenmap(bbox = c(-70.921099,43.045919,-70.829538, 43.127930), maptype = "toner-lite", zoom = 13, scale = "auto")
...
#if you want to add a map of the east coast and subset the map, follow the code below.
#map of east coast
